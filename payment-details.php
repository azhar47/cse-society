                                        ...
                                        <div class="row form-group">
                                            <div class="col-sm-8 col-sm-offset-2">
                                                ...
                                                <form action="<?php $_SERVER["PHP_SELF"]; ?>" method="POST">
                                                    ...
                                                    <input type="text"class="form-control form-group" name="semNumber" placeholder="Enter Semester Number.."/>
                                                    <input type="number" min="100" class="form-control form-group" name="amount"  placeholder="Enter Amount.." required/>
